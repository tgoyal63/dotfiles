...
link_path "$repo_dir/yabairc" "$HOME/.config/yabai/yabairc"
link_path "$repo_dir/skhdrc" "$HOME/.config/skhd/skhdrc"
link_path "$repo_dir/SHORTCUTS.md" "$HOME/.config/yabai/SHORTCUTS.md"
link_path "$repo_dir/scripts/aerospace/workspace-settings.sh" "$HOME/.config/yabai/workspace-settings.sh"
link_path "$repo_dir/scripts/yabai" "$HOME/.config/yabai/scripts"
